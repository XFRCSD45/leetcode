// class Solution {
// public:
//     bool solve(vector<int>&stones, int ind,int k,unordered_map<int,int>&map,unordered_map<pair<int,int>,bool>&mp)
//     {
//            if(ind==stones.size()-1)
//                return true;
//         bool ans1=false, ans2=false, ans3=false;
//         if(mp.find(make_pair(ind,k))!=mp.end())
//         {
//             return mp[make_pair(ind,k)];
//         }
...
//         return mp[make_pair(ind,k)]=ans1||ans2||ans3;
